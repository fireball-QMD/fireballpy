module M_system
  ...
  real*8, dimension(:,:), allocatable :: qmmm_dxyzcl  !Used to store the forces generated by qm_mm before adding them to the main f array.
  real*8, dimension(:,:),  allocatable ::  qmmm_qm_xcrd         !Contains imaged mm coordinates and scaled mm charges.
  real*8, dimension(:), allocatable :: qmmm_scf_mchg
  real*8, dimension(:), allocatable :: qmmm_Qneutral_TOT
