subroutine make_munuDipY ()
  ...
  use indices, only: indices_twocenter_set, INDICES_TWOCENTER_DIPY
  ...
  do in1 = 1, nspecies
    do in2 = 1, nspecies
      call indices_twocenter_set(INDICES_TWOCENTER_DIPY, lssh(1:nssh(in1),in1), &
        &                        lssh(1:nssh(in2),in2), index_max, s1, s2, ll1, ll2, m1, m2)
    end do
    if (index_max > ME2cDipY_max) ME2cDipY_max = index_max
  end do
  if (ME2cDipY_max > ME2c_max) ME2c_max = ME2cDipY_max
      ...
      do issh1 = 1, nssh(in1)
        ...
        do issh2 = 1, nssh(in2)
          ...
          do index = 1, index_max
            ...
            muDipY(index,in1,in2) = n1 + m1(index)
            nuDipY(index,in1,in2) = n2 + m2(index)
          end do
          n2 = n2 + l2
        end do
        n1 = n1 + l1
      end do
      index_max2cDipY(in1,in2) = index_max
    end do
  end do
