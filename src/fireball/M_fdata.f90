module M_fdata
  ...
  integer, parameter :: itheory = 1 !DOGS
  integer, parameter :: itheory_xc = 2 !McWEDA
  character(len=11), parameter :: infofname = "info.py.dat"
  !===================================
  ! info.dat variables
...
!    & 'vna_atom   ','vnl        ','(igual orden)xc_ontop   ','xc_atom    ','xc_corr    ','dipole_z   ','dipole_y   ', &
!    & 'dipole_x   ', &
...
!    & 'denS_ontopl','denS_ontopr','denS_atom  ','overlapS   '/)
  ...
  integer, parameter :: TWOCENTER_DIP_Y = 10
  integer, parameter :: TWOCENTER_DIP_X = 11
  integer, parameter :: TWOCENTER_COULOMB = 12
  integer, parameter :: TWOCENTER_KINETIC = 13
  integer, parameter :: TWOCENTER_DEN_L = 14
  integer, parameter :: TWOCENTER_DEN_R = 15
  integer, parameter :: TWOCENTER_DEN_A = 16
  integer, parameter :: TWOCENTER_DENS_L = 17
  integer, parameter :: TWOCENTER_DENS_R = 18
  integer, parameter :: TWOCENTER_DENS_A = 19
  integer, parameter :: TWOCENTER_OVERLAPS = 20
  ...
  integer, parameter :: initype(20) = [ &
                        ...
                        1, 1, 1, 1, 1, 1, & ! 14–19
                        0]                  ! 20
  integer, parameter :: maxtype_2c(20) = [ &
                        0, 1, 1, 1, 0, 0, & ! 1–6
                        1, 1, & ! 7–8
                        0, 0, 0, 0, 0, & ! 9–13
                        1, 1, 1, 1, 1, 1, & ! 14–19
  ...
  ! XC interactions; 7 implies different derivative types; there are five den3 arrays -
  ! - one for each theta, used only for SNXC method
...
contains
  character(len=200) function append_string(filename, extension)
    character(len=200), intent(in) :: filename
    character(len=200), intent(in) :: extension
    integer :: lenx
    integer :: leny
    integer :: len_trim
