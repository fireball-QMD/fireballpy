...
!
      ...
      real(kind=long), parameter :: a1 = 0.19645d0
      real(kind=long), parameter :: a2 = 0.27430d0
      real(kind=long), parameter :: a3 = 0.15084d0
      real(kind=long), parameter :: a4 = 100.d0
      real(kind=long), parameter :: ax = -0.7385588d0
      real(kind=long), parameter :: a = 7.7956d0
      real(kind=long), parameter :: b1 = 0.004d0
...
!  output: correlation contribution (alfc) to the spin stiffness
      real(kind=long), intent(in) :: rs, zet
      real(kind=long), intent(out) :: ec, vcup, vcdn, ecrs, eczet, alfc
      ...
      real(kind=long), parameter :: gam = 0.5198421d0
      real(kind=long), parameter :: fzz = 1.709921d0
      real(kind=long), parameter :: thrd = 0.333333333333d0
...
!
      subroutine gcor(a,a1,b1,b2,b3,b4,p,rs,gg,ggrs)
        use precision
        implicit none
        real(kind=long), intent(in) :: a,a1,b1,b2,b3,b4,p,rs
...
!      use precision
!      implicit none
!      real(kind=long), intent(in) :: rs, zet, t, uu, vv, ww
!      real(kind=long), intent(out) :: h, dvcup, dvcdn
!!
