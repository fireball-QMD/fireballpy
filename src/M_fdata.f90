module M_fdata
  ...
  real(wp), dimension (:), allocatable :: etotatom, smass, rc_PP
  character (len=2), dimension (:), allocatable :: symbolA
  integer, dimension (:,:), allocatable :: lssh, lsshPP
  real(wp), dimension (:,:), allocatable :: rcutoff, cl_PP, Qneutral
  ...
  real(wp), dimension(:,:), allocatable :: IR
  ...
  real(wp), dimension (:,:), allocatable :: exc1c_0
  real(wp), dimension (:,:,:), allocatable :: xcnu1c
  real(wp), dimension (:,:,:), allocatable :: xcnu1cs, exc1c0, nuxc1c, d2exc1c
  real(wp), dimension (:,:,:,:), allocatable :: exc1c, dexc1c, dnuxc1c
  real(wp), dimension (:,:,:,:,:), allocatable :: d2nuxc1c
  ...
  real(wp), dimension (:,:,:), allocatable :: z2cmax
  real(wp), dimension (:,:,:,:,:,:), allocatable :: splineint_2c
  ...
  real(wp), dimension (:,:), allocatable :: hx_bcna, hy_bcna, x3cmax_bcna, y3cmax_bcna
  real(wp), dimension (:,:,:,:,:), allocatable :: bcna_01, bcna_02, bcna_03, bcna_04, bcna_05
  ...
  !real(wp), dimension (:,:), allocatable :: hx_xc3c, hy_xc3c, x3cmax_xc3c, y3cmax_xc3c
  !real(wp), dimension (:,:,:,:,:), allocatable :: xc3c_01, xc3c_02, xc3c_03, xc3c_04, xc3c_05
  ...
  real(wp), dimension (:,:), allocatable :: hx_den3, hy_den3, x3cmax_den3, y3cmax_den3
  real(wp), dimension (:,:,:,:,:), allocatable :: den3_01, den3_02, den3_03, den3_04, den3_05
  real(wp), dimension (:,:,:,:,:), allocatable :: den3S_01, den3S_02, den3S_03, den3S_04, den3S_05
