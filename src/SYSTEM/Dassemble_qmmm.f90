subroutine Dassemble_qmmm ()
  ...
  implicit none
  integer :: iatom, imu, in1, in2, in3, ineigh, inu, issh, jatom, gatom, jmu, katom, mbeta
  real(wp) :: distance12, dij, dq1, dq2, dq3, dterm, sterm, out_charge
  real(wp), dimension (3) :: dewaldlr_i_qmmm, dewaldlr_j_qmmm, dewaldlr_k, dpterm, r1, r2, rhat12, spterm, vij
  real(wp), dimension (natoms) :: sub_ewaldqmmm
  real(wp), dimension (3, natoms) :: sub_dewaldqmmm
  real(wp), dimension (3, natoms, qmmm_qm_mm_pairs) :: dqmmm
