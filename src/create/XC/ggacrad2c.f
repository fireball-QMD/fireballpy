...
!
      ...
      real*8 r, rh, rhp, rhpp, rhz, rhzz, cpot, cen
      real*8 thrd,pi,pisq3,thrd2,crs,eps
      real*8 alfc,d,dp,dp11,dp12,dp22,dpp,dvcdn,dvcup,gks2
      real*8 gks2sq,h,rs,t,uu,vcdn,vcup,vv,ww,zet,ztp
...
! GGA correction to LSDA
     ...
     1                   rhpp(1), rhpp(2), rhz(1), rhz(2), rhzz(1),
     2                   rhzz(2), cen, cpot(1))
        else
          stop 'ggacrad : mode improper'
        endif
