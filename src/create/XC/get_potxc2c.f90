...
! Input
        ...
        real(kind=wp), intent(in) :: rhopz
        real(kind=wp), intent(in) :: rhoz
        real(kind=wp), intent(in) :: rhozz
...
! ===========================================================================
        ...
        real(kind=wp), dimension (2) :: dpz
        real(kind=wp), dimension (2) :: dz
        real(kind=wp), dimension (2) :: dzz
