...
! First derivative:
           rhop2c(irho,iz) =
     1      (rho2c(irho+1,iz) - rho2c(irho-1,iz))/(2.0d0*drho)

! Second derivative:
           rhopp2c(irho,iz) =
     1      (rho2c(irho+1,iz) - 2.0d0*rho2c(irho,iz)
     2       + rho2c(irho-1,iz))/(drho**2)
          end do
...
! First derivative:
           rhoz2c(irho,iz) =
     1      (rho2c(irho,iz+1) - rho2c(irho,iz-1))/(2.0d0*dz)

! Second derivative:
           rhozz2c(irho,iz) =
     1      (rho2c(irho,iz+1) - 2.0d0*rho2c(irho,iz)
     2       + rho2c(irho,iz-1))/(dz**2)
          end do
...
! Now calculate the cross term derivatives - rhopz2c.
         do irho = 1, nnrho
          do iz = 2, nnz - 1
           rhopz2c(irho,iz) =
     1      (rhop2c(irho,iz+1) - rhop2c(irho,iz-1))/(2.0d0*dz)
          end do
