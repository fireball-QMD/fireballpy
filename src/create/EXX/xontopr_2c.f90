...
! exchange ontop(right) interactions.
!
! ===========================================================================
! Code written by:
! James P. Lewis
...
! Program Declaration
! ===========================================================================
        subroutine xontopr_2c (nspec_max, isorp, fraction, nsshxc, &
...
!         write (*,*) ' ontop (right) case.  This routine can calculate matrix '
...
! Set up the header for the output file.
        write (iounit,100)
        write (iounit,*) ' Two-center exchange ontop (right) interactions: '
...
! value of the distance - d.
         call xontopr_2c_rprime (nspec_max, nsshxc, nalpha, itype2, rcutoff2,&
    &                            d, nrho, nz, lmax)
         d = d + dr
         do index = 1, index_max
          ...
          l2 = lright(index)
          m2 = mright(index)
          call xontopr_2c_integral (fraction, nalpha, lalpha, malpha, n1,    &
