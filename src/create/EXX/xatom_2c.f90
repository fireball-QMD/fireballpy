...
! Program Declaration
! ===========================================================================
        subroutine xatom_2c (nspec_max, isorp, fraction, &
...
! Write out the initial message.
        if (iammaster) then
         ...
         write (*,*) ' atom case.  This routine can calculate matrix elements '
         write (*,*) ' of s, p, d, and f interactions. '
         write (*,*) '  '
        end if
...
! Open the file to store the onecenter data.
        call iofile2c_x ('coutput/xatom_2c', 'dat', isorp, nzx1, nzx2, fname)
...
! Set up the header for the output file.
        write (iounit,100)
        write (iounit,*) ' Two-center exchange atom interactions: '
...
! the centers.
! For this ontop case the rprime integral needs to be evaluated at each
! value of the distance - d.
          call xatom_2c_rprime (n2, l2, m2, nalpha, lalpha, malpha, itype1,  &
    &                           itype2, rcutoff1, rcutoff2, d, nrho, nz, lmax) 

          call xatom_2c_integral (fraction, nalpha, lalpha, malpha, n1, l1,  &
     &                            m1, l2, m2, nz, nrho, d, itype1,       &
