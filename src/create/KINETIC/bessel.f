...
! L = 4
     ...
     1         - (105.0d0/x**4 - 10.0d0/x**2)*dcos(x)
         else
...
! L = 5
     ...
     1         - (945.0d0/x**5 - 105.0d0/x**3 + 1.0d0/x)*dcos(x)
         else
...
! L = 6
     ...
     1                                          - 1.0d0/x)*dsin(x)
     2         - (10395.0d0/x**6 - 1260.0d0/x**4 + 21.0d0/x**2)*dcos(x)
         else
